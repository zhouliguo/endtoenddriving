...
# python train/resnet_nuscenes_train.py --image-root /mnt/ssd/nuscenes/trainval/ --save-path weights/res_nuscenes --device 0 --batch-size 16 --num-workers 8 --res-chain 0