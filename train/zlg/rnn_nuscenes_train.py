...
from networks.zlg.rnn_nuscenes import LSTMModel as Model
...
def train_val(cfg):
    ...
    model = Model(pretrained=True, input_n=cfg.input_n, in_feature=2, out_features=cfg.predict_n*2).to(device)
